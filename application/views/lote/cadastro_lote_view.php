...
url_imagem_catalogo = "<?echo base_url('imagens/catalogo_cultura_variedade.png') ?>";
...
<h4 class="text-center"> Cadastrar Lote </h4>
...
<div class="box-cadastro-cli">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form name="cadastro_lote" method="post" action="<? echo base_url('lote/cadastrar_lote');?>">
				...
				<a style="cursor:pointer" class="link-cli-novo" onclick="exibir_mapa_var()">siglas cultura & variedades</a>
					...
					<div class="form-group">
						...
						<div class="select-cadastro-cli">
							<select class="form-control" id="fornecedor" name="fornecedor" onchange="gerar_lote()">
								...
								<option value="<? echo $cod; ?>" <? echo set_select('fornecedor',"$cod",($nome_fornec == "$cod" ? TRUE : FALSE ));?>><? echo $valor;?></option>
								<? } ?>
							</select>	 
						</div>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="tipo_mat" size="50" value="<? echo set_value('tipo_mat')?>">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="quantidade" name="quantidade" size="10" value="<? echo set_value('quantidade')?>">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control"  id="data_recebimento" name="data_recebimento" size="15" value="<? echo set_value('data_recebimento')?>">
					</div>
					...
					<div class="form-group">
						...
						<input readonly type="text" class="form-control"  id="lote" name="lote" size="15" value="<? echo set_value('lote')?>">		
					</div>
